...
Yukarıdaki örneği kullanarak **kendi ölçümlerinizle** bir tablo oluşturun (Aşağıda yeni bir tablo oluşturun ve yukarıdaki tabloya 3-4 tane kendi ölçümünü ekleyiniz.) Kullandığınız Google Sheet için [buraya](https://docs.google.com/spreadsheets/d/1_GJtq3HC4b_Tc2QwYcOKnqC33HxlYbFKN-WtKbfg800/edit#gid=0) link verin (Google Sheet herkese açık erişimli olsun.) 

a) Denkleminizi **y= 2,58E + 1,82x +- 1,24x^2**. Sizce a, b, ve c'nin fiziksel anlamları ne olabilir? (Yardım: bir tanesi ivme ile ilgili, bir tanesi ilk hız ile, diğeri konum ile ilgili).  Sizce niçin a'nın değeri negatif? a=ivme b=hız c=konum   a negatif çünkü cisim yavaşlıyor.

b) Hava sürtünmesini ihmal edersek, bu harakette ivme sabit midir? Sabit değildir.

c) Video'daki cismin atılış hızı farklı olsaydı (diğer herşey aynı, kütle, yüzey, vb. Hava sürtünmesini ihmal edin), sizce formülde hangi terimler değişecekti? (a, b veya c) a ve b değişirdi.
...
1) Kendi aldığınız verileri kullanarak **ortalama hız-zaman** grafiğini Google çiziniz. [Buraya](https://docs.google.com/spreadsheets/d/1usWSGlDH4iR30whqfxxKfFCdNEQ3AXWrhfeQaADkK0o/edit?usp=sharing) link veriniz.
...
3) İvme'yi ne buldunuz? Bu ivme değerini kullanarak 1kg'lık cisim ile yüzey arasındaki kinetik sürtünme katsayısını bulunuz.  **ivme=1,3307** 

# Bölüm 3 (Hala Beni Öldürmeyi Düşünmüyorsan)
1) Bu deneyde ölçüm hatalarım var. Zamandaki ölçüm hatam sizce kaç ms (mili saniye) nedir? Konumdaki ölçüm hatam sizce kaç cm'dir? **1/6ms ve 1cm**  

2) Acaba hiç grafik çizmeden sürtünme katsayısını bulabilir miydim?  (Cevap: Evet). 
Yardım:**Cismin kütlesini öğrenirsek rahatlıkla bulabiliriz.**
* Düzgün ivmelenen bir cisim için alınan yol formülü x = (ilk hız+ son hız)/2*t, burdan cismin ilk hızını bulunuz. **Alınan yolu 0,675m olarak aldım.İlk hızı 1,76 m/s buldum.**
* Daha sonra iş-kinetik enerji teorimini kullanarak sürtünme kuvvetini bulun. Sürtünme kuvvetinden, kinetik sürtünme katsayısını bulunuz. **W=1,5488 F=2,30 sürtünme katsayısını 0,23 olarak buldum.** 

3) Bu video'dan statik sürtünme katsayısını bulabilir miydim?  Hayır bulamazdık.
